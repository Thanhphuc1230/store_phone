                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <a href="{{ route('admin.sliders.index') }}"> <i class="ti-arrow-left"
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <img class="img-fluid img-thumbnail"
                                            src="{{ asset('images/sliders/' . $images) }}" alt=""
                                            width="250px">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc" class="form-control"
                                        value="{{ old('status', $slider->desc) }} ">
                                </div>
                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Trạng thái</h6>
                                    <select class="form-select" name="status">
                                        <option selected="" value="1"
                                            {{ old('status', $slider->status) == 1 ? 'selected' : '' }}>Hiện</option>
                                        <option value="0"
                                            {{ old('status', $slider->status) == 0 ? 'selected' : '' }}>Ẩn</option>
                                    </select>
                                </div>
