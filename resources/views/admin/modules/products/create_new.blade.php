                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        placeholder="vd: Iphone 13 Promax " value="{{ old('name') }}">
                                </div>

                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Price</h6>
                                    <input type="text" name="price" class="form-control"
                                        placeholder="vd: 2000000 đơn vị đã được mặc định là vnd"value="{{ old('price') }}">
                                </div>

                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Intro</h6>
                                    <input type="text" name="intro" class="form-control"
                                        placeholder="vd: Sản phẩm đời mới nhất" value="{{ old('intro') }}">
                                </div>

                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Content</h6>
                                    <input type="text" name="content" class="form-control"
                                        placeholder="vd: Dành cho tính đồ nhà táo" value="{{ old('content') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class=" mb-0">
                                        <input type="datetime-local" class="form-control" name="countdown"
                                            id="inputDateTime" value="{{ old('countdown') }}">
                                    </div>
                                </div>
