                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <a href="{{ route('admin.products.index') }}"> <i class="ti-arrow-left"
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        placeholder="vd: Iphone 13 Promax " value="{{ old('name', $product->name) }}">
                                </div>

                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Price</h6>
                                    <input type="text" name="price" class="form-control"
                                        placeholder="vd: 2000000 đơn vị đã được mặc định là vnd"value="{{ old('price', $product->price) }}">
                                </div>
                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Price old</h6>
                                    <input type="text" name="old_price" class="form-control"
                                        placeholder="vd: 2000000 đơn vị đã được mặc định là vnd"value="{{ old('price', $product->old_price) }}">
                                </div>

                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Intro</h6>
                                    <input type="text" name="intro" class="form-control"
                                        placeholder="vd: Sản phẩm đời mới nhất"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="content" class="form-control"
                                        placeholder="vd: Dành cho tính đồ nhà táo"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <img class="img-fluid img-thumbnail"
                                            src="{{ asset('images/products/' . $images) }}" alt=""
                                            width="250px">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="status_product">
                                        <option selected="" value="1"
                                            {{ old('status_product', $product->status_product) == 1 ? 'selected' : '' }}>
                                            Hiện</option>
                                        <option value="0"
                                            {{ old('status_product', $product->status_product) == 0 ? 'selected' : '' }}>
                                            Ẩn</option>
                                    </select>
                                </div>
