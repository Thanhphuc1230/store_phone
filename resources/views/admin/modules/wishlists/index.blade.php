                        ...
                        <table class="table dataTable no-footer dtr-inline"id='my-table' role="grid"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Yêu thích</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    @foreach ($wishlist as $wishlists)
                                        ...
                                        <td>{{ $wishlists->likes_top }}<i style="color: red;padding-left:5px"
                                                class="ti-heart"></i></td>
                                        ...
                                        <td>
                                            <div class="action_btns d-flex">
                                                <a onclick="return confirm('Xác nhận xóa sản phẩm ?')"
                                                    href="{{ route('admin.wishlists.destroy', ['id' => $wishlists->id_top]) }}"class="action_btn">
