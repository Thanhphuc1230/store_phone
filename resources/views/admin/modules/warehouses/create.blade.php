                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="import" class="form-control"
                                        placeholder=" Số lượng sản phẩm nhập vào" value="{{ old('import') }}">
                                </div>

                                <div class="mb-3">
                                    <h6 class="card-subtitle mb-2">Export</h6>
                                    <input type="text" name="export" class="form-control"
                                        placeholder="Số lượng sản phẩm bán ra"value="{{ old('import') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price_cost" class="form-control"
                                        placeholder="Giá vốn của sản phẩm" value="{{ old('price_const') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price_sale" class="form-control"
                                        placeholder="Giá bán ra" value="{{ old('price_sale') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price_discount" class="form-control"
                                        placeholder="Giá bán sau khi giảm giá "value="{{ old('price_discount') }}">
                                </div>
