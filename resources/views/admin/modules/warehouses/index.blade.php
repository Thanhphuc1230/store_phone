                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 133px;">Sản phẩm</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Nhập vào</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Bán ra</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Tồn kho</th>

                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Giá vốn</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 127px;">Giá bán</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 127px;">Giá giảm</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 67px;">Created</th>
                                    ...
                                    @foreach ($warehouses as $warehouse)
                                        ...
                                        <td>
                                            <div class="action_btns d-flex">
                                                <a
                                                    href="{{ route('admin.warehouses.edit', ['Wuuid' => $warehouse->Wuuid]) }}"class="action_btn mr_10">
                                                    <i class="far fa-edit"></i> </a>
                                                <a onclick="return confirm('Xác nhận xóa sản phẩm ?')"
                                                    href="{{ route('admin.warehouses.destroy', ['Wuuid' => $warehouse->Wuuid]) }}"class="action_btn">
