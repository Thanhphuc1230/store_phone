                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 133px;">Doanh thu</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 133px;">Số lượng sản phẩm</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Số lượng đơn hàng</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                        rowspan="1" colspan="1" style="width: 132px;">Ngày</th>
                                    <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                    ...
                                    @foreach ($turnovers as $turnover)
                                        ...
                                        <td>
                                            <div class="action_btns d-flex">
                                                <a href="{{ route('admin.turnovers.edit', ['id' => $turnover->order_date]) }}"
                                                    class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                <a onclick="return confirm('Xác nhận xóa sản phẩm ?')"
                                                    href="{{ route('admin.turnovers.destroy', ['id' => $turnover->id_turnover]) }}"class="action_btn">
