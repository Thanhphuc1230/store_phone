                                ...
                                <div class="login">
                                    <div class="login_form_container">
                                        <div class="account_login_form">
                                            <form action="{{ route('website.accountUpdate', ['uuid' => $user->uuid]) }}"
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="form-select" name="gender">
                                                        ...
                                                        <option value="1"
                                                            {{ old('gender', $user->gender) == 3 ? 'selected' : '' }}>Nam
                                                        </option>
                                                        <option value="2"
                                                            {{ old('gender', $user->gender) == 2 ? 'selected' : '' }}>Nữ
                                                        </option>
                                                        <option value="3"
                                                ...
                                                <div>
                                                    <img class="img-fluid img-thumbnail"
                                                        src="{{ asset('images/users/' . $avatar) }}" alt=""
                                                        width="200px">
                                                </div>
