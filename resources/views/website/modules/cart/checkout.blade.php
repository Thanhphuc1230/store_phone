                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="checkout_form_left">
                                <form action="{{ route('website.store', ['uuid' => $user->uuid]) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <input type="text" name="fullname_order"
                                                value="{{ old('fullname_order', $user->fullname) }}">
                                        </div>
                                        <div class="col-12 mb-20">
                                    ...
                                    <div class="col-12 mb-20">
                                        ...
                                        <label id="payment" for="address" data-bs-toggle="collapse"
                                            data-bs-target="#collapsetwo" aria-controls="collapseOne"
                                            aria-expanded="false">Thanh Toán ATM</label>

                                        <div id="collapsetwo" class="one collapse" data-parent="#accordion"
                                            style="">
                                            <div class="row">
                                                <div class="col-lg-6 mb-20">
                                                    <label for="payment" data-bs-toggle="collapse"
                                                        data-bs-target="#method" aria-controls="method">MB
                                                        BANK:888815052001<span>*</span></label>
