                                        ...
                                        @foreach ($cart as $item)
                                            <tr>
                                                <td class="product_remove"><a
                                                        href="{{ route('website.removeItemCart', ['id' => $item->rowId]) }}"><i
                                                            class="fa fa-trash-o"></i></a></td>
                                                <td class="product_thumb"><a
                                                        href="{{ route('website.detail', ['id' => $item->name]) }}"><img
                                                            src="{{ asset('images/products/' . $item->options->images) }}"
                                                            alt=""></a></td>
                                                ...
                                                <td class="product_quantity"><label>Quantity</label> <input
                                                        min="1" max="100"
                                                        name="quantity[{{ $item->rowId }}]" value="{{ $item->qty }}"
                                                        type="number"></td>
                            ...
                            <div class="coupon_code right">
                                ...
                                <div class="coupon_inner">
                                    ...
                                    <div class="checkout_btn">
                                        <a href="{{ route('website.checkout', ['uuid' => Auth::user()->uuid]) }}">Thanh
                                            Toán</a>
                                    </div>
                                </div>
                            </div>
