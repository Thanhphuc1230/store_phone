            ...
            <div class="categories_product_inner">
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category1.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category2.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category3.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category4.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category5.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category6.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category7.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category8.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category9.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="single_categories_product">
                    ...
                    <div class="categories_product_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/s-product/category10.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product_header">
                        ...
                        <div class="product_tab_btn">
                            <ul class="nav" role="tablist" id="nav-tab">
                                <li>
                                    <a class="active" data-toggle="tab" href="#Fashion" role="tab"
                                        aria-controls="Fashion" aria-selected="true">
                                        Fashion & Clothing
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="product_carousel product_style product_column5 owl-carousel">
                            ...
                            <figure>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product1.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product2.jpg') }}"
                                            alt=""></a>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="product-countdown.html">Eodem modo vel
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product3.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product4.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product5.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product6.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product7.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product8.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product9.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product10.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product11.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-countdown.html"><img
                                            src="{{ asset('website/assets/img/product/product12.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                    ...
                    <div class="product_carousel product_style product_column5 owl-carousel">
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="product-countdown.html">Natus erro at
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="product-countdown.html">Nullam maximus
                                                eget nisi dignissim sodales eget tempor</a></h4>
                                        <div class="price_box">
                                            <span class="old_price">$76.00</span>
                                            <span class="current_price">$75.00</span>
                                        </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content">
                                    <div class="product_content_inner">
                                        <h4 class="product_name"><a href="product-countdown.html">Donec tempus
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{ asset('website/assets/img/bg/banner4.jpg') }}"
                                    alt=""></a>
                        </div>
                    </figure>
                </div>
                <div class="col-lg-6 col-md-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{ asset('website/assets/img/bg/banner5.jpg') }}"
                                    alt=""></a>
                        </div>
                    </figure>
                </div>
                        ...
                        <div class="product_tab_btn">
                            <ul class="nav" role="tablist" id="nav-tab2">
                                ...
                                @foreach ($categories_featured as $cate)
                                    <li data-filter=".{{ Str::of($cate->name_cate)->slug('-') }}">
                                        <a data-toggle="tab" href="#Networking" role="tab"
                ...
                <div class="tab-pane fade show active" id="Computer" role="tabpanel">
                    <div class="product_carousel product_style product_column5 owl-carousel">
                        @foreach ($products_random as $product)
                            <div class="product_items {{ Str::of($product->price)->slug('.') }}">

                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a class="primary_img" href="product-details.html"><img
                                                    src="{{ asset('images/products/' . $product->images) }}"
                                                    alt=""></a>
                                            ...
                                            <div class="action_links">
                                                <ul>
                                                    ...
                                                    <li class="compare"><a href="#"
                                                            data-tippy-placement="top" data-tippy-arrow="true"
                                                            data-tippy-inertia="true" data-tippy="Add to Compare"><i
                                                                class="ion-ios-settings-strong"></i></a></li>
                                        ...
                                        <div class="product_content">
                                            <div class="product_content_inner">
                                                <h4 class="product_name"><a
                                                        href="{{ route('website.detail', ['id' => $product->id]) }}">{{ $product->name }}</a>
                                                </h4>
                                                <div class="price_box">
                                                    <span
                                                        class="old_price">{{ number_format($product->price, 0, '', '.') }}VND</span>
                                                    <span
                                                        class="current_price">{{ number_format($product->price, 0, '', '.') }}VND</span>
                                                </div>
                                            </div>
                                            <div class="add_to_cart">
                                                <a href="cart.html" title="Add to cart">Add to cart</a>
                            ...
                            <article class="single_product">
                                <figure>
                                    ...
                                    <div class="product_content">
                                        <div class="product_content_inner">
                                            <h4 class="product_name"><a
                                                    href="p{{ route('website.detail', ['id' => $product->id]) }}">{{ $product->name }}</a>
                                            </h4>
                                            <div class="price_box">
                                                <span
                                                    class="old_price">{{ number_format($product->price, 0, '', '.') }}VND</span>
                    ...
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product13.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product14.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product15.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product16.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                    ...
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product17.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product18.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product19.jpg') }}"
                                            alt=""></a>
                                    <a class="secondary_img" href="product-details.html"><img
                                            src="{{ asset('website/assets/img/product/product20.jpg') }}"
                                            alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">Sale</span>
                                    </div>
                ...
                <div class="product_header">
                    ...
                    <div class="product_tab_btn">
                        <ul class="nav" role="tablist" id="nav-tab3">
                            <li>
                                <a class="active" data-toggle="tab" href="#Fashion2" role="tab"
                                    aria-controls="Fashion2" aria-selected="true">
                                    Fashion & Clothing
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#Games2" role="tab" aria-controls="Games2"
                                    aria-selected="false">
                                    Games & Consoles
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#Headphone2" role="tab"
                                    aria-controls="Headphone2" aria-selected="false">
                                    Headphone & Speaker
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#Mobile2" role="tab" aria-controls="Mobile2"
                                    aria-selected="false">
                                    Mobile & Tablets
                                </a>
                            </li>
                ...
                <div class="product_carousel small_p_container  small_product_column3 owl-carousel">
                    <div class="product_items">
                        <figure class="single_product">
                            ...
                            <div class="product_content">
                                <h4 class="product_name"><a href="product-details.html">Officiis debitis varius
                                        risus dignissim massa quis</a></h4>
                        ...
                        <figure class="single_product">
                            ...
                            <div class="product_content">
                                <h4 class="product_name"><a href="product-details.html">Nemo enim nec elementum
                                        dolor bibendum vulputate libero</a></h4>
                                <div class="product_rating">
                                    <ul>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                    ...
                    <div class="product_items">
                        ...
                        <figure class="single_product">
                            ...
                            <div class="product_content">
                                <h4 class="product_name"><a href="product-details.html">Habitasse dictumst elementum
                                        elit blandit sit amet</a></h4>
                                <div class="product_rating">
                                    <ul>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                    ...
                    <div class="product_items">
                        <figure class="single_product">
                            ...
                            <div class="product_content">
                                <h4 class="product_name"><a href="product-details.html">Porro quisquam eget feugiat
                                        pretium posuere maximus</a></h4>
                                <div class="product_rating">
                                    <ul>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                        ...
                        <figure class="single_product">
                            ...
                            <div class="product_content">
                                <h4 class="product_name"><a href="product-details.html">Aliquam lobortis
                                        pellentesque eugiat pretium nisi lectus</a></h4>
                                <div class="product_rating">
                                    <ul>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                    ...
                    <div class="product_items">
                        ...
                        <figure class="single_product">
                            ...
                            <div class="product_content">
                                <h4 class="product_name"><a href="product-details.html">Itaque earum velit elementum
                                        mollis volutpat metus</a></h4>
                                <div class="product_rating">
                                    <ul>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                        <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                ...
                <div class="product_header">
                    ...
                    <div class="product_tab_btn">
                        <ul class="nav" role="tablist" id="nav-tab4">
                            <li>
                                <a class="active" data-toggle="tab" href="#Computer3" role="tab"
                                    aria-controls="Computer3" aria-selected="true">
                                    Computer
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#Networking2" role="tab"
                                    aria-controls="Networking2" aria-selected="false">
                                    Networking
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#Networking3" role="tab"
                                    aria-controls="Networking3" aria-selected="false">
                                    Computer & Networking
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#Audio2" role="tab" aria-controls="Audio2"
                                    aria-selected="false">
                                    Television & Audio
                                </a>
                            </li>
                ...
                <div class="product_carousel product_style product_column5 owl-carousel">
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <div class="product_content">
                                <div class="product_content_inner">
                                    <h4 class="product_name"><a href="product-details.html">Eodem modo vel mattis
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <figure class="single_banner">
                    <div class="banner_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/bg/banner6.jpg') }}"
                                alt=""></a>
                    </div>
                </figure>
            </div>
            <div class="col-lg-6 col-md-6">
                <figure class="single_banner">
                    <div class="banner_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/bg/banner7.jpg') }}"
                                alt=""></a>
                    </div>
                </figure>
            </div>
            <div class="col-lg-3 col-md-3">
                <figure class="single_banner">
                    <div class="banner_thumb">
                        <a href="shop.html"><img src="{{ asset('website/assets/img/bg/banner8.jpg') }}"
                                alt=""></a>
                    </div>
                </figure>
            </div>
                                ...
                                <div class="product_items">
                                    @foreach ($product as $item)
                                        <figure class="single_product">
                                            <div class="product_thumb">
                                                <a class="primary_img" href="product-details.html"><img
                                                        src="{{ asset('images/products/' . $item->images) }}"
                                                        alt=""></a>
                                                <a class="secondary_img" href="product-details.html"><img
                                                        src="{{ asset('images/products/' . $item->images) }}"
                                                        alt=""></a>
                                            ...
                                            <div class="product_content">
                                                <h4 class="product_name"><a
                                                        href="{{ route('website.detail', ['id' => $item->id]) }}">{{ $item->name }}</a>
                                                </h4>
                                                <div class="product_rating">
                                                    <ul>
                                                        <li><a href="#"><i
