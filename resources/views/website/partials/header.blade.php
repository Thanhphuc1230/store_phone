                    ...
                    <div class="col-lg-2 col-md-3 col-4">
                        <div class="logo">
                            <a href="{{ route('website.index') }}"><img
                                    src="{{ asset('website/assets/img/logo/PHONE STORE_free-file (3).png') }}"
                                    alt=""></a>
                        </div>
                    </div>
                                ...
                                <ul>
                                            ...
                                            <ul class="mega_menu_inner">
                                                <li><a href="#">Thương hiệu điện thoại</a>
                                                    <ul>
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <li><a
                                                                    href="{{ route('website.category', ['id' => $category->name_cate]) }}">{{ $category->name_cate }}</a>
                                                            </li>
                                                        @endforeach
                                                ...
                                                <li><a href="#">Phân khúc giá</a>
                                                    <ul>
                                                        @php
                                                            ...
                                                            $categoriesPrice = DB::table('categories')
                                                                ->where('id', 2)
                                                                ->where('status', 1)
                                                                ->get();
                                                        ...
                                                        @foreach ($categoriesPrice as $categoriesPrices)
                                                            <li><a
                                                                    href="{{ route('website.price', ['id' => $categoriesPrices->name_cate]) }}">Dưới
                                                                    5tr</a></li>
                                                            <li><a
                                                                    href="{{ route('website.price10tr', ['id' => $categoriesPrices->name_cate]) }}">Từ
                                                                    5tr-15tr</a></li>
                                                            <li><a
                                                                    href="{{ route('website.price20tr', ['id' => $categoriesPrices->name_cate]) }}">Từ
                                                                    15tr-25tr</a></li>
                                                            <li><a
                                                                    href="{{ route('website.price25tr', ['id' => $categoriesPrices->name_cate]) }}">Từ
                                                                    25tr trở lên</a></li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                                                <li><a href="#">Các dòng sản phẩm khác</a>
                                                    <ul>
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <li><a
                                                                    href="{{ route('website.product', ['id' => $category->name_cate]) }}">{{ $category->name_cate }}</a>
                                                            </li>
                                                        @endforeach
                                    ...
                                    <li><a href="#">pages <i class="fa fa-angle-down"></i></a>
                                        <ul class="sub_menu pages">
                                            ...
                                            <li><a href="https://www.facebook.com/Phone-Store-101136619424485"
                                                    target="__blank">Fanpage Facebook</a></li>
                                    ...
                                    @if (Auth::user())
                                        <li><a href="#">Profile <i class="fa fa-angle-down"></i></a>
                                            <ul class="sub_menu pages">
                                                <li><a
                                                        href="{{ route('website.account', ['uuid' => Auth::user()->uuid]) }}">My
                                                        Account</a></li>



                                                <li><a href="{{ route('website.wishlist') }}">Danh sách yêu thích</a>
                                                </li>
                                                <li><a
                                                        href="{{ route('website.cart', ['uuid' => Auth::user()->uuid]) }}">Giỏ
                                                        hàng</a></li>
                        ...
                        <div class="header_configure_area">
                            ...
                            <div class="mini_cart_wrapper">
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="cart_price">{{ Cart::total() }} VND <i
                                            class="fa-thin fa-cart-shopping"></i></span>
            ...
            <div class="mini_cart" style="overflow: croll">
                ...
                <div class="item_cart" style="overflow-y: scroll; height:250px">
                    @foreach ($cart as $item)
                        <div class="cart_item">
                            <div class="cart_img">
                                <a href="#"><img src="{{ asset('images/products/' . $item->options->images) }}"
                                        alt=""></a>
                            </div>
                            <div class="cart_info">
                                <a href="#">{{ $item->name }}</a>
                            ...
                            <div class="cart_remove">
                                <a href="{{ route('website.removeItemCart', ['id' => $item->rowId]) }}"><i
                                        class="fa-solid fa-x" style="color: black"></i></a>
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="mini_cart_footer">
                    ...
                    @if (Auth::user())
                        <div class="cart_button">
                            <a class="active"
                                href="{{ route('website.checkout', ['uuid' => Auth::user()->uuid]) }}">Checkout</a>
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="column1 col-lg-3 col-md-6">
                        <div class="categories_menu categories_three">
                            ...
                            <div class="categories_menu_toggle">
                                <ul>
                                    <li class="menu_item_children"><a href="#">Phone<i
                                    ...
                                    <li class="menu_item_children"><a href="#"> Tablet<i
                                                class="fa fa-angle-right"></i></a>
                                        <ul class="categories_mega_menu column_2">
                                            <li class="menu_item_children"><a href="#">Nhãn hàng</a>
                                                <ul class="categorie_sub_menu">
                                    ...
                                    <li class="menu_item_children"><a href="#"> Phụ kiện<i
                                                class="fa fa-angle-right"></i></a>
                                        <ul class="categories_mega_menu column_2">
                                    ...
                                    @if (Auth::user())
                                        <li class="menu_item_children"><a href="#"> Account<i
                                                    class="fa fa-angle-right"></i></a>
                                            <ul class="categories_mega_menu column_2">
                                                <li class="menu_item_children"><a href="#">Account</a>
                                                    <ul class="categorie_sub_menu">
                                                        ...
                                                        <li><a href="{{ route('website.wishlist') }}">Danh sách yêu
                                                                thích</a></li>
                                                        <li><a
                                                                href="{{ route('website.cart', ['uuid' => Auth::user()->uuid]) }}">Giỏ
                                                                hàng</a></li>
